...
private:
	...
	void preComputeRadiationMatrices(int nbRadFreqs);
	void interpolateRadiationImpedance(Eigen::MatrixXcd& imped, double freq); 
	void interpolateRadiationAdmittance(Eigen::MatrixXcd& admit, double freq);
	void radiationImpedance(Eigen::MatrixXcd& imped, double freq, double gridDensity);
};
